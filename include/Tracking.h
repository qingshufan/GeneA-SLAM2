...
public:
    ...
    Tracking(System* pSys, ORBVocabulary* pVoc, FrameDrawer* pFrameDrawer, MapDrawer* pMapDrawer, Atlas* pAtlas,
        shared_ptr<PointCloudMapping> pPointCloud, KeyFrameDatabase* pKFDB, const string &strSettingPath, const int sensor, Settings* settings, const string &_nameSeq=std::string());
...
protected:
    ...
    // For GeneA
    void RunGeneA(int& nmatches, std::vector<cv::KeyPoint>& all_red_keypoints);
    void OffsetCurrentMask();
